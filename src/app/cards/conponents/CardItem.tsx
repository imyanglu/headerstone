  ...
  return (
    <>
      <div className="py-[12px] flex w-full items-center">
        ...
        <div className="border-[4px] w-[200px] ml-auto mt-[4px] shadow-lg outline-[#e1c892] outline-[5px] outline border-[#000]  relative z-[2] rounded-[10px]">
