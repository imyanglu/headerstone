...
const Page = () => {
  return (
    <div className="w-[100vw] bg-[#E7D5A7] flex flex-col min-h-[100vh] ">
      <div className="w-full h-[100px] relative flex items-center bg-[#561212] ">
        ...
        />
        <div className="hidden md:block border-[4px] shadow-lg outline-[#7c221f] outline-[5px] outline border-[#000] ml-[12px] relative z-[2] rounded-[24px]">
